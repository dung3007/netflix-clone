    ...
    return (
        <div className='hero-bg relative'>
                ...
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                    <div className='flex-1'>
                        <div className='relative'>
                            <img src='/stranger-things-lg.png' alt='Stranger Things ing' className='mt-4' />
                    ...
                    <div className='flex-1 md:text-left text-center'>
                        ...
                        <p className='text-lg md:text-xl'>
                            Save your favorites easily and always have somethings to watch.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    <div className='flex-1 text-center md:text-left'>
                        <h2 className='text-4xl md:text-5xl font-extrabold mb-4'>Watch wverywhere.</h2>
                        <p className='text-lg md:text-xl'>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>
                    ...
                    <div className='flex-1 text-center md:text-left'>
                        ...
                        <p className='text-lg md:text-xl'>
                            Send kids on adventures with their favorite chracters in a space made just for them-free witj your membership
                        </p>
                    </div>
                </div>
            </div>
